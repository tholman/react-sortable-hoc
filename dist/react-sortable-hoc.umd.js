        ...
        createClass(WithSortableContainer, [
          ...
          },
          {
            ...
            value: function animateNodes() {
              ...
              var isAllowedToMoveToNode = function isAllowedToMoveToNode(
                _ref3,
              ) {
                var node = _ref3.node;
              ...
              var _loop = function _loop(i, len) {
                ...
                var offset = {
                  height:
                    _this4.height > height ? height / 2 : _this4.height / 2,
                ...
                if (_this4.axis.x) {
                  if (_this4.axis.y) {
                    if (
                      ...
                      var _nextEdgeOffset = getNextEdgeOffset(
                        DIRECTION.BACKWARD,
                      );
                    ...
                    if (
                      ...
                      var _nextEdgeOffset3 = getNextEdgeOffset(
                        DIRECTION.FORWARD,
                      );
                  ...
                  if (
                    ...
                    var _nextEdgeOffset4 = getNextEdgeOffset(
                      DIRECTION.BACKWARD,
                    );

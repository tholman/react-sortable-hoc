                  ...
                  (R.manager.active = {collection: c, index: s}),
                    ...
                    n ||
                      (0 === R.props.pressDelay
                        ? (R.handlePress(e),
                          i.sortableInfo.locked &&
                            ((i.sortableInfo.locked = !1),
                            (i.sortableInfo.wasLocked = !0)))
                    ...
                    if (r) {
                      var e = function() {
                          var e,
                            ...
                            d = b({index: s, node: C, collection: I});
                          if (
                            ((R.node = C),
                            (R.margin = c),
                            (R.gridGap = u),
                            ...
                            (R.boundingClientRect = C.getBoundingClientRect()),
                          ...
                          w &&
                            ...
                            (R.listenerNode = E.touches ? C : R.contentWindow),
                            T
            ...
            },
            {
              ...
              value: function() {
                var b = this,
                  ...
                  C = this.manager.getOrderedRefs(),
                  I = this.offsetEdge.left + this.translate.x + O.left,
                  ...
                  var D = function(e) {
                    ...
                    n = function(n, e) {
                      ...
                      f ||
                        ((f = _(t, b.container)),
                        (C[n].edgeOffset = f),
                        E && (C[n].boundingClientRect = K(t, O)));
                      var d = n < C.length - 1 && C[n + 1];
                      if (
                        (d &&
                          !d.edgeOffset &&
                      ...
                      if (b.axis.x) {
                        if (b.axis.y) {
                          ...
                          s ||
                          (o > b.index && I + k.left + l >= f.left)
                        ) {
                          var g = h(ce);
                          (u.x = g.left - f.left), (b.newIndex = o);
                        } else if (
                          c ||
                          (o < b.index && I + k.left <= f.left + l)
                        ) {
                          var v = h(se);
                          (u.x = v.left - f.left),
                            null == b.newIndex && (b.newIndex = o);
